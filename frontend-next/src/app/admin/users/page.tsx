      ...
      <div className="w-full max-w-lg rounded-2xl" style={surface}>
        ...
        <div className="p-5 space-y-4">
          <div className="grid grid-cols-2 gap-3">
            ...
            <LabeledInput label="Username" disabled value={form.username} onChange={(v) => setForm((f) => ({ ...f, username: v }))} />
          </div>
          <LabeledInput label="Email" value={form.email} onChange={(v) => setForm((f) => ({ ...f, email: v, username: v }))} />
          <div>
