...
export default function EmailTemplateConfigurator({ orgId, orgName }: EmailTemplateConfiguratorProps) {
  ...
  const sampleVars: Record<string, string> = {
    ...
    param_label: simulatedSeverity === 'CRITICAL' ? 'Top Oil Temperature' : 'Phase A-N Voltage — Over-voltage',
    param_key: simulatedSeverity === 'CRITICAL' ? 'oilTemp' : 'VoltAN',
    value: simulatedSeverity === 'CRITICAL' ? '92.5°C' : '243.2V',
    threshold: simulatedSeverity === 'CRITICAL' ? '90.0°C' : '241.5V',
    risk_insight: simulatedSeverity === 'CRITICAL' ? 'Winding & insulation degradation risk (>90°C)' : 'Phase A-N voltage above nominal limit',
