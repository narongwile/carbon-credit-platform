...
#define OO_TENANT      "org-eternity"
#define OO_PRODUCT     "eternity"     // eternity | carbonbox | bloodbox
#define OO_DEVICE_ID   "trxx81"       // must match a provisioned node row / alarm rule

// ---- Wi-Fi (transport rank 0; 4G/LoRa are interfaces in net_mqtt, see README)
#define OO_WIFI_SSID   "Itsara-1-2.4G"
#define OO_WIFI_PASS   "0818770280"

// ---- MQTT broker -----------------------------------------------------------
#define OO_MQTT_HOST   "27.254.143.144"
#define OO_MQTT_PORT   30883           // 8883 = TLS (prod); 1883 = plain (dev)
#define OO_MQTT_USER   "admin"             // empty = anonymous / cert-only auth
#define OO_MQTT_PASS   "iothub.2026"
#define OO_MQTT_TLS    0              // 1 = TLS/mTLS (prod); 0 = plain dev broker
