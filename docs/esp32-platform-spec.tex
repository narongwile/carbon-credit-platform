...
LoRaWAN, EOL manufacturing, partitions, hysteresis, memory budget, error recovery, OTA, config,
logging, testing (\S12--\S27).\quad
\textbf{Part~IV} — appendices: topic dictionary, payload examples, state machines (alarm lifecycle),
glossary (A--D).
\\[2pt]
