...
\textbf{Part~II} — hardware: ESP32-S3 PCB function map (\S10--\S11).\quad
\textbf{Part~III} — firmware concept design: architecture, boot, runtime, link FSM, diagnostics (\S12--\S17).
\\[2pt]
